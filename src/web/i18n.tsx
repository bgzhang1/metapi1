...
const zhToEn: Record<string, string> = {
  ...
  '模型名称': 'Model Name',
  '模型名称规范化': 'Model Name Normalization',
  '模型规范化设置已保存': 'Model normalization settings saved',
  '启用 LLM 规范化': 'Enable LLM Normalization',
  '保存规范化设置': 'Save Normalization Settings',
  '开启后，在模型发现时调用大语言模型自动规范化模型名称（关闭时使用内置正则规则）。': 'When enabled, calls a large language model during model discovery to auto-normalize model names (uses built-in regex rules when disabled).',
  '操作': 'Actions',
  '每页条数': 'Rows Per Page',
  '查看': 'Viewing',
  '来自供应商': 'From Provider',
